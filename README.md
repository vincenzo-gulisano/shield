...
* `java -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=localhost:5005 -jar target/Shield-1.0-SNAPSHOT-jar-with-dependencies.jar -v -nt 10 -f experiment.txt`
