...
public final class LclFlowMainQuery {
    ...
    public static QueryResult process(List<Tuple> inputStream, String queryId, Settings settings) {
        ...
        // Source: replay daily household tuples from the prepared LCL flow dataset.
        Source<Tuple> source = query.addBaseSource(
                "source-" + queryId,
                CollectionSourceFactory.fromList(inputStream, 0L));
        // Active-day filter: remove empty or almost empty household-days before alert logic.
        ...
        // Tariff router: send Std records to the first branch and ToU records to the second branch.
        ...
        // Branch alert filters: keep household-days with high daily load and at least one
        // load-shape warning signal.
        ...
        // Branch key maps: collapse household keys into one key per tariff so the following
        // summary groups all alerting households by day and tariff.
        ...
        // Summary flat maps: emit one aggregate alert tuple per completed day/tariff group.
        ...
        // Count filters: suppress branch summaries based on too few alerting households.
        ...
        // Sinks: collect final semantic outputs from the two independent tariff branches.
